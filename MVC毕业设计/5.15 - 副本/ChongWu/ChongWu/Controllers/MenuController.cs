...
namespace ChongWu.Controllers
{
    public class MenuController : Controller
    {
        ...
        public ActionResult kong111() {
            return View();
        }
        public ActionResult kong1()
        {
            var shuju = db.pettype.ToList();
            ...
            ViewData["ddl"] = new SelectList(shuju, "PetID", "PetName");
            return View(shuju);
        }
        ...
        public ActionResult Index1(int id)
        {
            ...
            int userid = id;
            var userr = db.Userr.Where(a => a.Usid == id).FirstOrDefault();
            ViewData["username"] = userr.UName;
